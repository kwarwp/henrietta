...
class Cenatemplo():
     def __init__(self):
        ...
        def conta_historia(*_):
            historia = input("Conte aqui a sua histÃÂ³ria")
        ...
        #quebra_cabeca_oceano = Elemento(img=,tit="quebra_cabeÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ§a_oceano",style=dict(left=100, top=160, width=60, height=200))
